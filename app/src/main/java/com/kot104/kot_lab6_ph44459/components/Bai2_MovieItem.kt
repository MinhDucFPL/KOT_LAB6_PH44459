package com.kot104.kot_lab6_ph44459.components
...
import com.kot104.kot_lab6_ph44459.model.ListType
import com.kot104.kot_lab6_ph44459.model.MovieModel

@Composable
fun MovieRow(movies: List<MovieModel>) {
    LazyRow(
...
@Composable
fun MovieColumn(movies: List<MovieModel>) {
    LazyColumn(
        state = rememberLazyListState(),
        contentPadding = PaddingValues(horizontal = 8.dp, vertical = 16.dp),
...
@Composable
fun MovieGrid(movies: List<MovieModel>) {
...
@Composable
fun MovieItem(movie: MovieModel, listType: ListType) {
    Card(
...
@Composable
fun MovieColumnItem(movie: MovieModel, listType: ListType) {
    Card(
        colors = CardDefaults.cardColors(containerColor =
        Color.White),
        elevation = CardDefaults.cardElevation(defaultElevation =
